...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('DhMainBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('Dh\MainBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('Dh\MainBundle\Form\NoteType', $note);
